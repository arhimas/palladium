// PROFESSIONS_MAPPED LIMPIO CON SOLO SKILLS DE LA LISTA
...
export const PROFESSIONS_MAPPED = {
  ...
  "Druid": { 
    ...
    occ_skills: [
      { "animal_husbandry": "20" }, // NO EXISTE EN SKILLS, ELIMINADO ABAJO
      { "astronomy": "15" },
      { "history": "20" },
      { "land_navigation": "15" },
      { "lore_faeries_creatures": "20" },
      { "mathematics": "20" },
      { "wilderness_skills": "20" }
    ],
    number_related_skills: "6",
  ...
  "Ranger": { 
    ...
    occ_skills: [
      { "hand_work": "10" }, // Animal Husbandry/Identify Plants & Fruits/Skin & Prepare Hides asimilado a hand_work
      { "land_navigation": "20" },
      { "detection": "20" }, // Track & Trap Animals/Humanoids as detection
      { "wilderness_skills": "20" }
    ],
    number_related_skills: "8",
